...
#    plt.plot(plt.xlim(), [random_chance_mAP, random_chance_mAP], color='k', linestyle='dotted', label='chance')
    ...
    plot_filename = os.path.join(PLOT_DIR, '11_21_23-plot.png')
    legend_filename = os.path.join(PLOT_DIR, '11_21_23-LEGEND.png')
