...
class DenseCLIP(nn.Module):
    ...
    def forward(self, image, norm=True):
        ...
        prompts, prompts_pos, prompts_neg, temperature, spatial_T = self.prompt_learner()
        ...
        logits_pos = logit_scale * image_features @ text_features_pos.t()    #  HW * B * C,  cls * C,  HW * B * cls
        ...
        logits_pos_g = logit_scale * image_feature_ @ text_features_pos.t()    # B * C,  cls * C,  B * cls
        ...
        logits_ = logits_pos - logits_neg
        logits_g = logits_pos_g - logits_neg_g
