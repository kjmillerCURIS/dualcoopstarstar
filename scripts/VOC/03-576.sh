...
CFG=rn101_bn128  # config file
CTP=end  # class token position (end or middle)
NCTX=21  # number of context tokens
CSC=True  # class-specific context (False or True)
MOD=pos200
run_ID=voc2007_partial_tricoop_wta_soft_448_CSC_p0_3-pos200-ctx21-576
partial_prob=0.3
...
run_ID=voc2007_partial_tricoop_wta_soft_448_CSC_p0_4-pos200-ctx21-576
partial_prob=0.4
