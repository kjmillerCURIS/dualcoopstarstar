...
import trainers.Caption_tri_wta_soft_pseudolabel_conflict_cleaninitial
...
#    cfg.TRAIN.TERNARY_COOCCURRENCE_LOSS_OFF_DURATION = 0 #obsolete
    cfg.TRAIN.CONFLICT_MATRIX_NAME = ''
    cfg.TRAIN.USE_GTMARGS = 0
    cfg.TRAIN.CONFIDENTONLY = 0
    cfg.TRAIN.CLEAN_P = 0.0
    cfg.TRAIN.CLEAN_Q = 0.0
    cfg.TRAIN.CLEAN_R = 0.0
