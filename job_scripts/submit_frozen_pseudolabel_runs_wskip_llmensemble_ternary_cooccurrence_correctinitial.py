...
DEBUG = False
SCRIPT_NAME = 'generic_COCO_frozen_pseudolabel_wskip_learnedensemble_ternary_cooccurrence_correctinitial.sh'


def submit_frozen_pseudolabel_runs_wskip_llmensemble_ternary_cooccurrence_correctinitial():
                            ...
                            for betterPolysemy in ['']: #['_betterPolysemy']: #['', '_betterPolysemy']:
                                ...
                                for orig_classnames_init in [1]: #[1, 0]:
                                    for three_sep in [0]: #[1, 0]:
                                        job_name = 'frozen_pseudolabel_wskip_%s_originit%d_threesep%d_ternary_cooccurrence_correctinitial_%s_%s_%.5f_%.5f_coco_seed1'%(llm_name, orig_classnames_init, three_sep, ternary_cooccurrence_loss_type, ternary_cooccurrence_mat_name, ternary_cooccurrence_alpha, ternary_cooccurrence_beta_over_alpha)
...
if __name__ == '__main__':
    submit_frozen_pseudolabel_runs_wskip_llmensemble_ternary_cooccurrence_correctinitial()
