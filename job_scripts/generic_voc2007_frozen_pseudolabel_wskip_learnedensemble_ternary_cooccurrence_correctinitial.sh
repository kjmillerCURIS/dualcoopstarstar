...
TRAINER=Caption_tri_wta_soft_pseudolabel_learnedensemble_ternary_cooccurrence_correctinitial
...
do
    ...
    python train_caption_pseudolabel_learnedensemble_ternary_cooccurrence_correctinitial.py \
    --root ${DATA} \
    --seed ${SEED} \
    --trainer ${TRAINER} \
