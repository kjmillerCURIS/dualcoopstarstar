...
TRAINER=Caption_tri_wta_soft_pseudolabel_ternary_cooccurrence_multistagecorrection
...
do
    ...
    python train_caption_pseudolabel_ternary_cooccurrence_multistagecorrection.py \
    --root ${DATA} \
    --seed ${SEED} \
    --trainer ${TRAINER} \
    ...
    TRAIN.MULTISTAGECORRECTION_EPOCHS ${MULTISTAGECORRECTION_EPOCHS} \
    TRAIN.MULTISTAGECORRECTION_MU ${MULTISTAGECORRECTION_MU}
done
