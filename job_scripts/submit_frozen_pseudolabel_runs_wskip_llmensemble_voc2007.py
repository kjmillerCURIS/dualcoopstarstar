...
DEBUG = False
SCRIPT_NAME = 'generic_voc2007_frozen_pseudolabel_wskip_learnedensemble.sh'


def submit_frozen_pseudolabel_runs_wskip_llmensemble_voc2007():
        ...
        for appendClass in ['_appendOrigClassname']:
            for betterPolysemy in ['', '_betterPolysemy']:
                ...
                for orig_classnames_init in [1]:
                    for three_sep in [0]:
                        job_name = 'frozen_pseudolabel_wskip_%s_originit%d_threesep%d_voc2007_seed1'%(llm_name, orig_classnames_init, three_sep)
...
if __name__ == '__main__':
    submit_frozen_pseudolabel_runs_wskip_llmensemble_voc2007()
