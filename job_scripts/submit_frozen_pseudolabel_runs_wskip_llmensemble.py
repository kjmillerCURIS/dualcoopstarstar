...
DEBUG = False
SCRIPT_NAME = 'generic_COCO_frozen_pseudolabel_wskip_learnedensemble.sh'


def submit_frozen_pseudolabel_runs_wskip_llmensemble():
            ...
            for betterPolysemy in ['', '_betterPolysemy']:
                ...
                for orig_classnames_init in [1, 0]:
                    for three_sep in [1, 0]:
                        job_name = 'frozen_pseudolabel_wskip_%s_originit%d_threesep%d_coco_seed1'%(llm_name, orig_classnames_init, three_sep)
...
if __name__ == '__main__':
    submit_frozen_pseudolabel_runs_wskip_llmensemble()
