...
DEBUG = False
SCRIPT_NAME = 'generic_second_max_experiments.sh'
...
def submit_second_max_experiments_runs():
    for model_type in ['ViT-L14336px']: #MODEL_TYPE_LIST:
        for dataset_name in ['nuswideTheirVersion_partial']: #DATASET_NAME_LIST:
            job_name = 'secondmax_%s_%s'%(dataset_name.split('_')[0], model_type)
...
if __name__ == '__main__':
    submit_second_max_experiments_runs()
