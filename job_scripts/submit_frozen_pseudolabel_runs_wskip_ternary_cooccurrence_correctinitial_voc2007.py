...
DEBUG = False
SCRIPT_NAME = 'generic_voc2007_frozen_pseudolabel_wskip_ternary_cooccurrence_correctinitial.sh'


def submit_frozen_pseudolabel_runs_wskip_ternary_cooccurrence_correctinitial_voc2007():
        ...
        for ternary_cooccurrence_mat_name in ['gt_epsilon0.25_zeta0.25','expectedsurprise_removepositives_20loc_1lpc','expectedsurprise_confonly','expectedsurprise_fillin_20loc_3lpc','expectedsurprise_fillin_missingmiddle_20loc_3lpchigh_1lpclow']:
            for ternary_cooccurrence_alpha in {'correlation' : [0.0075], 'prob_stopgrad_logit' : [0.25]}[ternary_cooccurrence_loss_type]:
                for ternary_cooccurrence_beta_over_alpha in [0.5]:
                    job_name = 'frozen_pseudolabel_wskip_ternary_cooccurrence_correctinitial_%s%s_%.5f_%.5f_voc2007_seed1'%(loss_type_str, ternary_cooccurrence_mat_name, ternary_cooccurrence_alpha, ternary_cooccurrence_beta_over_alpha)
...
if __name__ == '__main__':
    submit_frozen_pseudolabel_runs_wskip_ternary_cooccurrence_correctinitial_voc2007()
