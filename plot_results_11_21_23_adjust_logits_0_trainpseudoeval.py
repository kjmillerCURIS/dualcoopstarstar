...
def plot_results_11_21_23_adjust_logits_0_trainpseudoeval():
    plt.clf()
    ...
    plot_filename = os.path.join(PLOT_DIR, '11_21_23_adjust_logits_0-trainpseudoeval-plot.png')
    legend_filename = os.path.join(PLOT_DIR, '11_21_23_adjust_logits_0-trainpseudoeval-LEGEND.png')
...
if __name__ == '__main__':
    plot_results_11_21_23_adjust_logits_0_trainpseudoeval()
