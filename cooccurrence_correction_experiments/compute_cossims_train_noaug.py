...
from run_calibration_experiments import get_input_filename
sys.path.append('.')
import clip
...
def compute_cossims_train_noaug(dataset_name, model_type, single_probe_type):
...
def usage():
    print('Usage: python compute_cossims_train_noaug.py <dataset_name> <model_type> <single_probe_type>')


if __name__ == '__main__':
    compute_cossims_train_noaug(*(sys.argv[1:]))
