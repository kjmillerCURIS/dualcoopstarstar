...
def tablify_results_11_21_23_adjust_logits_0_trainpseudoeval():
    rows = []
    ...
    f = open(os.path.join(TABLE_DIR, '11_21_23_adjust_logits_0-trainpseudolabel-table.csv'), 'w')
    for row in rows:
        f.write(','.join(row) + '\n')
...
if __name__ == '__main__':
    tablify_results_11_21_23_adjust_logits_0_trainpseudoeval()
