...
import trainers.Caption_tri_wta_soft_pseudolabel_ternary_cooccurrence_textangle
...
def extend_cfg(cfg):
    ...
    cfg.TRAIN.TERNARY_COOCCURRENCE_ALPHA = 1.0
    cfg.TRAIN.TERNARY_COOCCURRENCE_BETA_OVER_ALPHA = 1.0
